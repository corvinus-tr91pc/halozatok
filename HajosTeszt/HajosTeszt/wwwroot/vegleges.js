...
function init() {
    ...
    document.getElementById("gomb_vissza").addEventListener("click", hátra);
    document.getElementById("gomb_előre").addEventListener("click", előre);
...
function választás(n) {
    ...
    localStorage.setItem("nextQuestion", JSON.stringify(hotList));
}
